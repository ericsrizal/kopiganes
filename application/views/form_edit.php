<!--<html>
	...
	<body>
		<form method="POST" action="<?php echo base_url()."index.php/Admin_menu/do_update"; ?>" enctype="multipart/form-data">
		<table>
			<tr>
				<td>Kode</td>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="active">
                                <i class="fa fa-edit"></i> Form Edit
                            </li>
                        </ol>
                    </div>
                </div>
                    ...
                    <div class="col-lg-6">
						<form method="POST" action="<?php echo base_url()."index.php/Admin_menu/do_update"; ?>" enctype="multipart/form-data">
                        	...
                        	<div class="form-group">
                                <label>Kode</label>
                                <input class="form-control" input type="text" name="kode" value="<?php echo $kode; ?>" readonly>
                            </div>

                        	<div class="form-group">
                                <label>Nama</label>
                                <input class="form-control" input type="text" name="nama" value="<?php echo $nama; ?>">
                            </div>

                            <div class="form-group">
                                <label>Harga</label>
                                <input class="form-control" input type="text" name="harga" value="<?php echo $harga; ?>">
                            </div>

                            <div class="form-group">
                                <label>Jenis (makanan, minuman, atau snack)</label>
                                <input class="form-control" input type="text" name="jenis" value="<?php echo $jenis; ?>" >
                            </div>
